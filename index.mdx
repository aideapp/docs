...
- **One click integrations**- for popular support and eCommerce and CRM platforms — Zendesk, Gorgias, Front, Shopify, WooCommerce, and Salesforce, with the ability to integrate with custom APIs as needed. See the next page for information on integrations.
